...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"HOME/task2.js":[function(require,module,exports) {
getJSON("https://jsonplaceholder.typicode.com/users").then(generateListItems).then(generateUnorderedList).then(addUsersToPage);

function getJSON(url) {
  return fetch(url).then(r => r.ok ? r.json() : Promise.reject("unseccessfull request"));
}
...
},{}]},{},["C:/Users/Администратор/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","HOME/task2.js"], null)
//# sourceMappingURL=/task2.fc79488e.js.map