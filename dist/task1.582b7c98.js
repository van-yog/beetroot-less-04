...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"HOME/task1.js":[function(require,module,exports) {
/* 
...
function queryApi(endpoint) {
  return fetch(URL + endpoint).then(r => r.ok ? r.json() : Promise.reject("unseccessfull request"));
}

Promise.all([queryApi("posts"), queryApi("users")]).then(([postsArr, usersArr]) => {
  let postsCounterOb = {};
  postsArr.forEach(({
    userId
  }) => {
  ...
  postsArr.forEach((post, idx) => !(idx % 10) && showPost(post, usersArr, postsCounterOb));
}).catch(err => {
  console.log(err);
...
function handleAuthor({
  ...
  if (target.className === "author-link") {
    ...
    hiddenBlock.attributes[0].value = style === "display:none" ? "display:block" : "display:none";
  }
}
...
},{}]},{},["C:/Users/Администратор/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","HOME/task1.js"], null)
//# sourceMappingURL=/task1.582b7c98.js.map